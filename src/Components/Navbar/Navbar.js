        ...
        <div className="container-fluid">
          <div className="row">
            ...
            <div className="col-lg-6 col-sm-2 col-md-4 ml-auto">
              <button
                className="navbar-toggler toggler-position"
                type="button"
                  ...
                  <ul className="navbar-nav me-auto mb-2 mb-lg-0 nav-row-link">
                    ...
                    <li className="nav-item">
                      <div className="dropdown ">
                        <Button
                          variant="outlined"
                          className="button-1  dropdown-toggle"
                          type="button"
                      ...
                      <div class="dropdown">
                        ...
                        >
                          <li>
                            <a class="dropdown-item" href="#">
                              <img
                                src="https://drfsb8fjssbd3.cloudfront.net/images/egy.svg"
                                alt="Flag Image"
                                class="lazy"
                              />
                              English
                          ...
                          <li>
                            <a class="dropdown-item" href="#">
                              <img
                                src="https://drfsb8fjssbd3.cloudfront.net/images/Flag-UAE.svg"
                                alt="Flag Image"
                                class="lazy"
                              ></img>{" "}
                              UAE{" "}
